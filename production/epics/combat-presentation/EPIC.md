...
performance-budget checks, jump/fall character animation coverage, and remaining
weapon presentation variants. The epic stays In Progress until all feedback
modes satisfy `design/gdd/combat-presentation.md`.
