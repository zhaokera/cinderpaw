...
const FACTORY_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_COIL_OPENING_GRACE_FRAMES: int = 10
...
const FACTORY_OBJECTIVE_CROSS_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE: StringName = (
	&"cross_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace"
)
const FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_CROSSED: StringName = (
	&"forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed"
)
const FACTORY_OBJECTIVE_CLEAR_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_AMBUSH: StringName = (
	&"clear_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush"
)
...
const FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_AMBUSH_ID: StringName = (
	&"old_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush"
)
...
const FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_ACTIVATION_X: float = 12020.0
const FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_EXIT_X: float = 12480.0
const FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_AMBUSH_ACTIVATION_X: float = 12620.0
...
@onready var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache: Node = (
	get_node_or_null(
...
@onready var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_duct: Sprite2D = (
	get_node_or_null(
		"FactoryLowerDeckForwardPressureAftershockCondenserOverflowPumpRunoffOutletServiceSluiceTailraceDuct"
	)
		as Sprite2D
)
@onready var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_vent: Node = (
	get_node_or_null(
		"FactoryLowerDeckForwardPressureAftershockCondenserOverflowPumpRunoffOutletServiceSluiceTailraceVent"
	)
)
@onready var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat: Node2D = (
	get_node_or_null(
...
var _last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_reward: Dictionary = {}
var _last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback: Dictionary = {}
...
func is_factory_route_objective_complete() -> bool:
	...
	return (
		...
		or objective_id == FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_EXIT_GATE_OPENED
				...
				or objective_id == FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_CROSSED
				or objective_id == FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_AMBUSH_CLEARED
			)
...
## Attempts to claim the service-sluice payoff cache after its Spark Rat clears.
func try_claim_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache(
	provider: Node = null
) -> bool:
	if (
		not _is_overflow_pump_runoff_outlet_service_sluice_skirmish_cleared()
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache == null
	):
		return false
	var claim_provider: Node = provider if provider != null else _player
	if (
		not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache.has_method(
			"try_claim"
		)
		or not bool(
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache.call(
				"try_claim",
				claim_provider
			)
		)
	...
	var reward_payload: Dictionary = (
		_get_overflow_pump_runoff_outlet_service_sluice_reward_cache_payload()
	)
	if (
		_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_reward
		.is_empty()
	):
		_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_reward = (
			reward_payload
		)
	_sync_overflow_pump_runoff_outlet_service_sluice_reward_cache_state()
	if (
		_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback
		.is_empty()
	):
		_record_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback(
			reward_payload,
...
## Starts the service-sluice tailrace traversal beyond the opened exit hatch.
func try_activate_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace(
	provider: Node = null
) -> bool:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_duct == null
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_vent == null
		or not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_available()
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_activated
	):
		return false
	var activation_provider: Node = provider if provider != null else _player
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_provider_at_activation(
		activation_provider
	):
		return false
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_activated = true
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_elapsed_sec = 0.0
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_state()
	_refresh_factory_route_objective()
	return true


## Advances the service-sluice tailrace steam cycle deterministically.
func advance_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_time(
	delta_sec: float
) -> void:
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_active():
		return
	var safe_delta_sec: float = maxf(0.0, delta_sec)
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_elapsed_sec += safe_delta_sec
	_factory_hazard_elapsed_sec += safe_delta_sec
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_state()


## Completes the tailrace once Cinderpaw reaches the far service channel edge.
func try_complete_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace(
	provider: Node = null
) -> bool:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_duct == null
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_vent == null
		or not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_active()
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
	):
		return false
	var completion_provider: Node = provider if provider != null else _player
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_provider_at_exit(
		completion_provider
	):
		return false
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_activated = true
...
## Starts the Coil Rat ambush after Cinderpaw crosses the service-sluice tailrace.
func try_activate_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush(
	provider: Node = null
) -> bool:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat == null
		or not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_available()
		...
		return false
	var activation_provider: Node = provider if provider != null else _player
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_provider_in_range(
		activation_provider
	):
		return false
	...
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_state()
	_set_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_attack_target(
		activation_provider
	)
	_begin_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_pacing(
		FACTORY_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_COIL_OPENING_GRACE_FRAMES
	)
	_refresh_factory_route_objective()
	return true
	...
	return {
		...
		"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_reward_cache_claimed": (
			...
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed": (
				_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
			),
		...
		"last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_reward": (
			_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_reward
			.duplicate(true)
		),
		"last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback": (
			_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback
			.duplicate(true)
		),
...
func set_local_state(state: Dictionary) -> void:
	...
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claimed = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claimed",
			false
		)
	...
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_activated = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_activated",
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
		)
	...
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_elapsed_sec = 0.0
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated",
			false
		)
	...
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_activated = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_activated",
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated
		)
	...
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated:
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_activated = true
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed = true
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed:
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_activated = true
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_exit_hatch_opened = true
	...
	var lower_deck_forward_pressure_service_sluice_reward_variant: Variant = state.get(
		"last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_reward",
		{}
	)
	_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_reward = (
		(
			lower_deck_forward_pressure_service_sluice_reward_variant
			as Dictionary
		).duplicate(true)
		if lower_deck_forward_pressure_service_sluice_reward_variant is Dictionary
		else {}
	)
	var lower_deck_forward_pressure_service_sluice_feedback_variant: Variant = state.get(
		"last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback",
		{}
	)
	_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback = (
		(
			lower_deck_forward_pressure_service_sluice_feedback_variant
			as Dictionary
		).duplicate(true)
		if lower_deck_forward_pressure_service_sluice_feedback_variant is Dictionary
		else {}
	)
...
## Returns deterministic service-sluice reward cache diagnostics.
func get_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_diagnostics(
) -> Dictionary:
	var route: Dictionary = get_factory_route_objective_diagnostics()
	var cache: Node = (
	...
	return {
		"present": cache != null,
		"service_sluice_skirmish_cleared": (
			_is_overflow_pump_runoff_outlet_service_sluice_skirmish_cleared()
		),
		"available": (
			bool(cache.call("is_available"))
		...
		"cache_id": String(
			cache.call("get_cache_id")
			if cache != null and cache.has_method("get_cache_id")
			else FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_REWARD_CACHE_ID
		),
		"texture_path": (
			_get_overflow_pump_runoff_outlet_service_sluice_reward_cache_texture_path()
		),
		"prompt_text": (
			_get_overflow_pump_runoff_outlet_service_sluice_reward_cache_prompt_text()
		),
		"position": _get_overflow_pump_runoff_outlet_service_sluice_reward_cache_position(),
		"last_reward": (
			_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_reward
			.duplicate(true)
		),
...
## Returns deterministic service-sluice tailrace diagnostics for tests/MCP.
func get_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_diagnostics(
) -> Dictionary:
	var route: Dictionary = get_factory_route_objective_diagnostics()
	var duct: Sprite2D = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_duct
	)
	var hazard: Area2D = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_vent
			as Area2D
	)
	var ground := get_node_or_null("Ground") as Node2D
	var ground_shape := get_node_or_null("Ground/CollisionShape2D") as CollisionShape2D
	...
	return {
		...
		"available": _is_overflow_pump_runoff_outlet_service_sluice_tailrace_available(),
		"active": _is_overflow_pump_runoff_outlet_service_sluice_tailrace_active(),
		"crossed": (
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
		),
		"visible": duct.visible if duct != null else false,
		...
		"phase": String(_get_overflow_pump_runoff_outlet_service_sluice_tailrace_phase()),
		"initial_grace_sec": FACTORY_LOWER_DECK_FORWARD_PRESSURE_INITIAL_GRACE_SEC,
		"warning_sec": FACTORY_LOWER_DECK_FORWARD_PRESSURE_WARNING_SEC,
		"active_sec": FACTORY_LOWER_DECK_FORWARD_PRESSURE_ACTIVE_SEC,
		"safe_sec": FACTORY_LOWER_DECK_FORWARD_PRESSURE_SAFE_SEC,
		...
		"exit_x": (
			FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_EXIT_X
		),
		"right_wall_x": right_wall.global_position.x if right_wall != null else 0.0,
		"camera_limit_right": camera.limit_right if camera != null else 0,
		"background_width": background.size.x if background != null else 0.0,
...
## Returns deterministic service-sluice tailrace Coil Rat ambush diagnostics.
func get_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_diagnostics(
) -> Dictionary:
	var route: Dictionary = get_factory_route_objective_diagnostics()
	var coil_rat: Node2D = _get_valid_node2d(
	...
	return {
		...
		"available": _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_available(),
		"active": _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_active(),
		"cleared": _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_cleared(),
		"coil_visible": coil_rat.visible if coil_rat != null else false,
		"coil_node_name": String(coil_rat.name) if coil_rat != null else "",
		"coil_has_target": _does_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_have_target(),
		"coil_physics_enabled": coil_rat.is_physics_processing() if coil_rat != null else false,
		"coil_process_enabled": coil_rat.is_processing() if coil_rat != null else false,
		"coil_entity_id": _get_enemy_entity_id(coil_rat),
		"coil_family_id": _get_enemy_family_id(coil_rat),
		...
		"coil_animation_frame_counts": _get_sprite_animation_frame_counts(coil_sprite),
		"pacing": _get_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_pacing_diagnostics(),
		"activation_x": (
...
func _bind_enemy_to_player() -> void:
	...
	_bind_factory_guard(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat,
		FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_AMBUSH_ID,
		FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_COIL_ENTITY_ID,
		&"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat",
		_on_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated
	)
...
func _on_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated() -> void:
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_activated = true
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated = true
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_state()
	_refresh_factory_route_objective()
...
func _sync_overflow_pump_runoff_outlet_service_sluice_reward_cache_state() -> void:
	var cache: Node = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache
	)
	if cache != null:
...
func _sync_overflow_pump_runoff_outlet_service_sluice_tailrace_state() -> void:
	var should_show_tailrace: bool = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_exit_hatch_opened
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
	)
	if (
		...
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_duct.visible = (
			should_show_tailrace
		)
	var hazard: Area2D = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_vent
			as Area2D
...
func _sync_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_state() -> void:
	var ambush_active: bool = (
		_is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_active()
	)
	_sync_lower_deck_forward_pressure_aftershock_exit_enemy_state(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat,
		ambush_active
			and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated
	)
...
func _get_factory_route_objective_id() -> StringName:
	...
	if _is_overflow_pump_runoff_outlet_service_sluice_tailrace_active():
		return (
			FACTORY_OBJECTIVE_CROSS_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE
		)
	if _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_active():
		return (
	...
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed:
		return (
			FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_CROSSED
		)
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_exit_hatch_opened:
		return (
...
func _get_factory_route_objective_text(objective_id: StringName) -> String:
	match objective_id:
		...
		FACTORY_OBJECTIVE_CROSS_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE:
			return "Cross Service Sluice Tailrace"
		FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_CROSSED:
...
func _get_overflow_pump_runoff_outlet_service_sluice_reward_cache_payload(
) -> Dictionary:
	var cache: Node = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache
	)
...
func _record_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback(
	reward: Dictionary,
	label_prefix: String
) -> void:
	_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claim_feedback = (
...
func _get_overflow_pump_runoff_outlet_service_sluice_reward_cache_prompt_text(
) -> String:
	var cache: Node = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache
	)
...
func _get_overflow_pump_runoff_outlet_service_sluice_reward_cache_texture_path(
) -> String:
	var cache: Node = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache
	)
...
func _get_overflow_pump_runoff_outlet_service_sluice_reward_cache_position(
) -> Vector2:
	return (
		(
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache
		...
		if (
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache
			!= null
			and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache
			is Node2D
		)
		else Vector2.ZERO
	)
	...
	return (
		hazard_id == &"old_factory_steam_vent"
			...
			or hazard_id == FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_DRIP_VENT_HAZARD_ID
				...
				or hazard_id == FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_HAZARD_ID
		)
...
func _set_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_attack_target(
	attack_target: Node
) -> void:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat != null
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat.has_method(
			"set_attack_target"
		)
	):
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat.call(
			"set_attack_target",
			attack_target
		)
...
func _begin_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_pacing(
	opening_grace_frames: int
) -> void:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat != null
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_pacing_diagnostics(
) -> Dictionary:
	var pacing: Dictionary = (
		_get_lower_deck_forward_pressure_coil_pincer_enemy_pacing_diagnostics(
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat,
	...
	pacing["active"] = _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_active()
	return pacing
...
func _does_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_have_target(
) -> bool:
	var coil_rat: Node2D = _get_valid_node2d(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat
	)
	...
	if coil_rat.has_method("has_attack_target"):
		return bool(coil_rat.call("has_attack_target"))
	return _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_active()
...
func _sync_factory_damage_target_defeat(target_id: int, damage_target: Node) -> void:
	...
	match target_id:
		...
		FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_COIL_ENTITY_ID:
			if (
				not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated
			):
				_on_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated()
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_provider_at_activation(
	provider: Node
) -> bool:
	if provider == null or not provider is Node2D:
		return false
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_provider_at_exit(
	provider: Node
) -> bool:
	if provider == null or not provider is Node2D:
		return false
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_provider_in_range(
	provider: Node
) -> bool:
	if provider == null or not provider is Node2D:
		return false
...
func _is_overflow_pump_runoff_outlet_service_sluice_reward_cache_available() -> bool:
	return (
		_is_overflow_pump_runoff_outlet_service_sluice_skirmish_cleared()
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_reward_cache_claimed
	)
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_available() -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_exit_hatch_opened
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_activated
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_active() -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_activated
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_exit_hatch_opened
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_available(
) -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_activated
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_active() -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_activated
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_coil_rat_defeated
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_cleared(
) -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_ambush_activated
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_contact_active() -> bool:
	return (
		_is_overflow_pump_runoff_outlet_service_sluice_tailrace_active()
		and _get_overflow_pump_runoff_outlet_service_sluice_tailrace_phase() == &"active"
	)
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_phase() -> StringName:
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_crossed:
		return &"crossed"
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_active():
		return &"idle"
	var elapsed_sec: float = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_elapsed_sec
	)
	if elapsed_sec < FACTORY_LOWER_DECK_FORWARD_PRESSURE_INITIAL_GRACE_SEC:
		return &"grace"
	var cycle_sec: float = (
