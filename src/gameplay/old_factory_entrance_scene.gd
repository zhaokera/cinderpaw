...
const FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_REWARD_CACHE_ID: StringName = (
...
const FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_HAZARD_ID: StringName = (
...
const FACTORY_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_SPARK_OPENING_GRACE_FRAMES: int = 10
const FACTORY_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_COIL_OPENING_GRACE_FRAMES: int = 24
const FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_ACTIVATION_X: float = 13760.0
const FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_EXIT_X: float = 14320.0
...
const FACTORY_OBJECTIVE_CROSS_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF: StringName = (
	&"cross_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff"
)
const FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_CROSSED: StringName = (
	&"forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed"
)
const FACTORY_OBJECTIVE_BREAK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER: StringName = (
	&"break_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer"
)
const FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_CLEARED: StringName = (
	&"forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared"
)
const FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_CACHE_CLAIMED: StringName = (
	&"forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cache_claimed"
)
...
@onready var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache: Node = (
	get_node_or_null(
...
@onready var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_duct: Sprite2D = (
	get_node_or_null(
		"FactoryLowerDeckForwardPressureAftershockCondenserOverflowPumpRunoffOutletServiceSluiceTailraceRelayRunoffDuct"
	)
		as Sprite2D
)
@onready var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_vent: Node = (
	get_node_or_null(
...
@onready var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat: Node2D = (
	get_node_or_null(
...
var _last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_reward: Dictionary = {}
var _last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback: Dictionary = {}
...
var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated: bool = false
var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed: bool = false
var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_elapsed_sec: float = 0.0
var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated: bool = false
var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated: bool = false
var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated: bool = false
var _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed: bool = false
...
func _process(_delta: float) -> void:
	...
	_auto_complete_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff()
	_auto_activate_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer()
...
func is_factory_route_objective_complete() -> bool:
	...
	return (
		...
		or objective_id == FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_EXIT_GATE_OPENED
				...
				or objective_id == FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_CLEARED
...
## Starts the short runoff vent pocket after the service-sluice tailrace relay.
func try_activate_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff(
	provider: Node = null
) -> bool:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_duct == null
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_vent == null
		or not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_available()
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated
	):
		return false
	var activation_provider: Node = provider if provider != null else _player
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_provider_at_activation(
		activation_provider
	):
		return false
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated = true
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_elapsed_sec = 0.0
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_state()
	_refresh_factory_route_objective()
	return true


## Advances the post-relay runoff vent cycle deterministically for tests/MCP.
func advance_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_time(
	delta_sec: float
) -> void:
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_active():
		return
	var safe_delta_sec: float = maxf(0.0, delta_sec)
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_elapsed_sec += safe_delta_sec
	_factory_hazard_elapsed_sec += safe_delta_sec
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_state()


## Completes the post-relay runoff pocket after Cinderpaw reaches the far edge.
func try_complete_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff(
	provider: Node = null
) -> bool:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_duct == null
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_vent == null
		or not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_active()
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
	):
		return false
	var completion_provider: Node = provider if provider != null else _player
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_provider_at_exit(
		completion_provider
	):
		return false
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated = true
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed = true
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_elapsed_sec = 0.0
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_state()
	_refresh_factory_route_objective()
	return true
...
## Starts the post-runoff Spark/Coil Rat pincer after the relay runoff is crossed.
func try_activate_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer(
	provider: Node = null
) -> bool:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat == null
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat == null
		or not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_available()
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated
	):
		return false
	var activation_provider: Node = provider if provider != null else _player
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_provider_in_range(
		activation_provider
	):
		return false
	...
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_state()
	_set_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_attack_targets(
		activation_provider
	)
...
## Attempts to claim the post-pincer payoff cache after both enemies are defeated.
func try_claim_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache(
	provider: Node = null
) -> bool:
	if (
		not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared()
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache == null
	):
		return false
	var claim_provider: Node = provider if provider != null else _player
	if (
		not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache.has_method(
			"try_claim"
		)
		or not bool(
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache.call(
				"try_claim",
				claim_provider
			)
		)
		...
		return false
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed = true
	var reward_payload: Dictionary = (
		_get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_payload()
	)
	if (
		_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_reward
		.is_empty()
	):
		_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_reward = (
			reward_payload
		)
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_state()
	if (
		_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback
		.is_empty()
	):
		_record_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback(
			reward_payload,
			"Tailrace Runoff Pincer Cache Claimed"
		)
	_update_route_label("Tailrace Runoff Pincer Cache Claimed +20 Gears")
	return true
	...
	return {
		...
		"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_reward_cache_claimed": (
			...
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated": (
				_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated
			),
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed": (
				_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
			),
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated": (
				_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated
			),
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_spark_rat_defeated": (
				_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated
			),
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_coil_rat_defeated": (
				_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated
			),
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared": (
				_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared()
			),
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed": (
				_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed
			),
		...
		"last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_reward": (
			_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_reward
			.duplicate(true)
		),
		"last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback": (
			_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback
			.duplicate(true)
		),
...
func set_local_state(state: Dictionary) -> void:
	...
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed",
			false
		)
	)
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated",
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
		)
	...
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_elapsed_sec = 0.0
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_spark_rat_defeated",
			false
		)
	)
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_coil_rat_defeated",
			false
		)
	...
	if bool(state.get(
		...
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated = true
	...
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated",
			(
				_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated
				and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated
			)
		)
	)
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed = bool(
		state.get(
			"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed",
			false
		)
	)
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed:
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated = true
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated = true
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated = true
	if _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared():
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed = true
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated = true
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed:
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated = true
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_activated = true
	...
	var lower_deck_forward_pressure_pincer_reward_variant: Variant = state.get(
		"last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_reward",
		{}
	)
	_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_reward = (
		(
			lower_deck_forward_pressure_pincer_reward_variant
			as Dictionary
		).duplicate(true)
		if lower_deck_forward_pressure_pincer_reward_variant is Dictionary
		else {}
	)
	var lower_deck_forward_pressure_pincer_feedback_variant: Variant = state.get(
		"last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback",
		{}
	)
	_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback = (
		(
			lower_deck_forward_pressure_pincer_feedback_variant
			as Dictionary
		).duplicate(true)
		if lower_deck_forward_pressure_pincer_feedback_variant is Dictionary
		else {}
	)
...
## Returns deterministic post-tailrace-relay runoff diagnostics for tests/MCP.
func get_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_diagnostics(
) -> Dictionary:
	var route: Dictionary = get_factory_route_objective_diagnostics()
	var duct: Sprite2D = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_duct
	)
	var hazard: Area2D = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_vent
			as Area2D
	)
	return {
		...
		"available": (
			_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_available()
		),
		"active": (
			_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_active()
		),
		"crossed": (
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
		),
		...
		"safe_sec": FACTORY_LOWER_DECK_FORWARD_PRESSURE_SAFE_SEC,
		"activation_x": (
			FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_ACTIVATION_X
		),
		"exit_x": (
			FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_EXIT_X
		),
		"right_wall_x": _get_factory_route_right_wall_x(),
		"camera_limit_right": _get_factory_route_camera_limit_right(),
		"background_width": _get_factory_route_background_width(),
...
## Returns deterministic post-runoff Spark/Coil Rat pincer diagnostics.
func get_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_diagnostics(
) -> Dictionary:
	var route: Dictionary = get_factory_route_objective_diagnostics()
	var spark_rat: Node2D = _get_valid_node2d(
	...
	return {
		"present": spark_rat != null and coil_rat != null,
		"tailrace_relay_runoff_crossed": (
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
		),
		"available": (
			_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_available()
		),
		"active": (
			_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_active()
		),
		"cleared": (
			_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared()
		),
		"activation_x": (
			FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_ACTIVATION_X
		),
		...
		"coil_visible": coil_rat.visible if coil_rat != null else false,
		"spark_has_target": (
			_does_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_have_target()
		),
		"coil_has_target": (
			_does_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_have_target()
		),
		"spark_physics_enabled": (
		...
		"coil_animation_frame_counts": _get_sprite_animation_frame_counts(coil_sprite),
		"spark_pacing": (
			_get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_pacing_diagnostics()
		),
		"coil_pacing": (
			_get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_pacing_diagnostics()
		),
		"spark_position": spark_rat.global_position if spark_rat != null else Vector2.ZERO,
...
## Returns deterministic post-pincer reward cache diagnostics.
func get_factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_diagnostics(
) -> Dictionary:
	var route: Dictionary = get_factory_route_objective_diagnostics()
	var cache: Node = (
	...
	return {
		...
		"cache_id": String(
			...
			if cache != null and cache.has_method("get_cache_id")
			else FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_REWARD_CACHE_ID
		),
		"texture_path": (
			_get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_texture_path()
		),
		"prompt_text": (
			_get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_prompt_text()
		),
		"position": (
			_get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_position()
		),
		"last_reward": (
			_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_reward
			.duplicate(true)
...
func _bind_enemy_to_player() -> void:
	...
	_bind_factory_guard(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat,
		FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_ID,
		FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_SPARK_ENTITY_ID,
		&"factory_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat",
		_on_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated
	)
	_bind_factory_guard(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat,
		FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_ID,
		FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_COIL_ENTITY_ID,
...
func _on_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated(
) -> void:
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated = true
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated = true
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_state()
...
func _on_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated(
) -> void:
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated = true
	_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated = true
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_state()
...
func _sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_state(
) -> void:
	var should_show_runoff: bool = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_activated
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
	)
	if (
		...
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_duct.visible = (
			should_show_runoff
		)
	var hazard: Area2D = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_vent
...
func _sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_state(
) -> void:
	var pincer_active: bool = (
		_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_active()
	)
	_sync_lower_deck_forward_pressure_coil_pincer_enemy_state(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat,
		pincer_active
			and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated
	)
	_sync_lower_deck_forward_pressure_coil_pincer_enemy_state(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat,
		pincer_active
			and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated
	)
	_sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_state()


func _sync_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_state(
) -> void:
	var cache: Node = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache
	)
	...
	cache.visible = (
		_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared()
		or _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed
	)
	if cache.has_method("set_available"):
		cache.call(
			"set_available",
			_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_available()
		)
	if cache.has_method("set_claimed"):
		cache.call(
			"set_claimed",
...
func _get_factory_route_objective_id() -> StringName:
	...
	if _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_active():
		return (
			FACTORY_OBJECTIVE_CROSS_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF
		)
	if _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_active():
		return (
			FACTORY_OBJECTIVE_BREAK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER
		)
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed:
		return (
	...
	if _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared():
		return (
			FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_CLEARED
		)
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed:
		return (
			FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_CROSSED
		)
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_activated:
		return (
...
func _get_factory_route_objective_text(objective_id: StringName) -> String:
	...
	if (
		...
		return "Cross Tailrace Relay Runoff"
	if (
		objective_id
		== FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_CROSSED
	):
		return "Tailrace Relay Runoff Crossed"
	if (
		objective_id
		== FACTORY_OBJECTIVE_BREAK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER
	):
		return "Break Tailrace Runoff Pincer"
	if (
		objective_id
		== FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_CLEARED
	):
		return "Tailrace Runoff Pincer Cleared"
	if (
		objective_id
		== FACTORY_OBJECTIVE_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_PINCER_CACHE_CLAIMED
	):
		return "Tailrace Runoff Pincer Cache Claimed +20 Gears"
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_payload(
) -> Dictionary:
	var cache: Node = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache
	)
...
func _record_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback(
	reward: Dictionary,
	label_prefix: String
) -> void:
	_last_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claim_feedback = (
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_prompt_text(
) -> String:
	var cache: Node = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache
	)
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_texture_path(
) -> String:
	var cache: Node = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache
	)
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_position(
) -> Vector2:
	return (
		(
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache
		...
		if (
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache
			!= null
			and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache
			is Node2D
		)
		else Vector2.ZERO
	)
	...
	return (
		hazard_id == &"old_factory_steam_vent"
			...
			or hazard_id == FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_DRIP_VENT_HAZARD_ID
				...
				or hazard_id == FACTORY_LOWER_DECK_FORWARD_PRESSURE_AFTERSHOCK_CONDENSER_OVERFLOW_PUMP_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_HAZARD_ID
		)
...
func _set_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_attack_targets(
	attack_target: Node
) -> void:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat != null
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat.has_method(
			"set_attack_target"
		)
	):
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat.call(
			"set_attack_target",
			attack_target
		)
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat != null
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat.has_method(
			"set_attack_target"
		)
	):
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat.call(
			"set_attack_target",
			attack_target
		)
...
func _begin_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_pacing(
) -> void:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat != null
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat.has_method(
		...
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat.call(
			"begin_pacing",
			FACTORY_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_SPARK_OPENING_GRACE_FRAMES
		)
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat != null
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat.has_method(
		...
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat.call(
			"begin_pacing",
			FACTORY_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_COIL_OPENING_GRACE_FRAMES
		)
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_pacing_diagnostics(
) -> Dictionary:
	var pacing: Dictionary = (
		_get_lower_deck_forward_pressure_coil_pincer_enemy_pacing_diagnostics(
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat,
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_pacing_diagnostics(
) -> Dictionary:
	var pacing: Dictionary = (
		_get_lower_deck_forward_pressure_coil_pincer_enemy_pacing_diagnostics(
			_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat,
...
func _does_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_have_target(
) -> bool:
	var spark_rat: Node2D = _get_valid_node2d(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat
	)
...
func _does_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_have_target(
) -> bool:
	var coil_rat: Node2D = _get_valid_node2d(
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat
	)
...
func _sync_factory_damage_target_defeat(target_id: int, damage_target: Node) -> void:
	...
	match target_id:
		...
		FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_SPARK_ENTITY_ID:
			if (
				not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated
			):
				_on_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated()
		FACTORY_LOWER_DECK_FORWARD_AFTERSHOCK_CONDENSER_OVERFLOW_RUNOFF_OUTLET_SERVICE_SLUICE_TAILRACE_RELAY_RUNOFF_COIL_ENTITY_ID:
			if (
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_provider_at_activation(
	provider: Node
) -> bool:
	if provider == null or not provider is Node2D:
		return false
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_provider_at_exit(
	provider: Node
) -> bool:
	if provider == null or not provider is Node2D:
		return false
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_provider_in_range(
	provider: Node
) -> bool:
	if provider == null or not provider is Node2D:
		return false
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_available(
) -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_activated
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_active(
) -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_activated
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_activated
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_available(
) -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated
		and not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared()
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_active(
) -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
		and not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared()
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared(
) -> bool:
	return (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_spark_rat_defeated
		and _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_coil_rat_defeated
	)


func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_available(
) -> bool:
	return (
		_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared()
		and not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_reward_cache_claimed
	)
...
func _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_contact_active(
) -> bool:
	return (
		_is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_active()
		and _get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_phase()
		== &"active"
	)
...
func _get_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_phase(
) -> StringName:
	if _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed:
		return &"crossed"
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_active():
		return &"idle"
	var elapsed_sec: float = (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_elapsed_sec
	)
	if elapsed_sec < FACTORY_LOWER_DECK_FORWARD_PRESSURE_INITIAL_GRACE_SEC:
		return &"grace"
	var cycle_sec: float = (
...
func _auto_activate_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff(
	...
	if (
		...
		return
	if (
		not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_activated
	):
		return
...
func _auto_complete_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff(
) -> void:
	if not _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_active():
		return
...
func _auto_activate_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer(
) -> void:
	if (
		_lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_activated
		or _is_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_pincer_cleared()
	):
		return
	if (
		not _lower_deck_forward_pressure_aftershock_condenser_overflow_pump_runoff_outlet_service_sluice_tailrace_relay_runoff_crossed
	):
		return
