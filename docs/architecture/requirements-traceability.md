...
| TR-ID | Requirement | ADR Coverage | Status |
|-------|-------------|-------------|--------|
| TR-combatfx-001~009 | 帧停/震屏/粒子/残影/伤害数字/闪白/性能/色盲/专注模式 | ADR-0001, ADR-0002, ADR-0004, ADR-0005, ADR-0016 | ⚠️ Stories 001-026 implement the tracked presentation slices. Story021 Main, Story022 Crown Warden, [Story023 Sluice Matriarch](../../production/epics/combat-presentation/story-023-sluice-matriarch-real-hitstop-input-buffer.md), [Story024 Central Tower](../../production/epics/combat-presentation/story-024-central-tower-real-hitstop-input-buffer.md), and [Story026 Neon Rooftops](../../production/epics/combat-presentation/story-026-neon-rooftops-combat-impact.md) verify real hitstop/input integration. [Story025 Crown Warden death hold](../../production/epics/combat-presentation/story-025-crown-warden-victory-death-presentation-hold.md) adds the exact kill-feedback and delayed-payoff contract; [Story025 evidence](../../production/qa/evidence/crown-warden-victory-death-presentation-hold-2026-07-15.md), [Story026 evidence](../../production/qa/evidence/neon-rooftops-combat-impact-2026-07-15.md). Remaining independent combat scenes keep the Epic open. |
